...
from dqn import DQN, load_checkpoint
...
def main():
    ...
    with sc2_env.SC2Env(
        ...
        check_point_path = "models/deepq/checkpoint.pth.tar"
        dqn = DQN()
        dqn, saved_mean_reward = load_checkpoint(dqn, filename=check_point_path)
        while True:
            episode_rewards = [0.0]
            obs = env.reset()
